...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/GdalRasterize">-a_srs "EPSG:32632" -a NORM -co "TILED=YES" -co "BLOCKXSIZE=512" -co "BLOCKYSIZE=512" -co "COMPRESS=DEFLATE" -ot Float32 -a_nodata "-1.0" -tr 10 10<xsl:apply-templates select="@*|node()" /></xsl:template>
