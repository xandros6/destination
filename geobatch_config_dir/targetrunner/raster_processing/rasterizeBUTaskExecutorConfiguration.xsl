...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/GdalRasterize">-a_srs "EPSG:32632" -co "TILED=YES" -co "BLOCKXSIZE=512" -co "BLOCKYSIZE=512" -ot Float32 -a_nodata 0 -tr 10 10 -a "NORM" -co "COMPRESS=DEFLATE"<xsl:apply-templates select="@*|node()" /></xsl:template>
