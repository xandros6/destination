...
CREATE OR REPLACE VIEW v_geo_aree_agricole_pl  AS 
  ...
  INNER JOIN siig_t_bersaglio_non_umano ON siig_geo_bers_non_umano_pl.idgeo_bers_non_umano_pl = siig_t_bersaglio_non_umano.fk_bers_non_umano_pl
  INNER JOIN siig_t_bersaglio ON siig_t_bersaglio.id_bersaglio = siig_t_bersaglio_non_umano.id_bersaglio
  INNER JOIN siig_d_partner ON siig_d_partner.id_partner = siig_t_bersaglio_non_umano.id_partner
  INNER JOIN siig_d_classe_clc ON siig_d_classe_clc.id_classe_clc = siig_t_bersaglio_non_umano.fk_classe_clc  
  WHERE siig_t_bersaglio_non_umano.id_bersaglio = 13;  
...
CREATE OR REPLACE VIEW v_geo_acque_superficiali_pt AS
	SELECT siig_d_partner.partner, 
				 siig_t_bersaglio_non_umano.id_tematico, 
				 siig_t_bersaglio.descrizione AS descrizione_bersaglio, 
				 siig_t_bersaglio_non_umano.fk_bers_non_umano_pl, 
	...
	FROM 	 siig_d_classe_clc 
				 ...
				 ON siig_t_bersaglio.id_bersaglio = siig_t_bersaglio_non_umano.id_bersaglio) 
				 ON siig_d_classe_clc.id_classe_clc = siig_t_bersaglio_non_umano.fk_classe_clc
	WHERE (((siig_t_bersaglio_non_umano.id_bersaglio)=15));
