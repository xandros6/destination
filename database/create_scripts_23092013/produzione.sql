...
--
-- Name: siig_d_dettaglio; Type: TABLE; Schema: siig_p; Owner: siig_p; Tablespace: 
--
...
ALTER TABLE siig_p.siig_d_dettaglio OWNER TO siig_p;
...
--
-- Name: siig_d_ente; Type: TABLE; Schema: siig_p; Owner: siig_p; Tablespace: 
--
...
ALTER TABLE siig_p.siig_d_ente OWNER TO siig_p;
...
--
-- Name: siig_d_ruolo; Type: TABLE; Schema: siig_p; Owner: siig_p; Tablespace: 
--
...
ALTER TABLE siig_p.siig_d_ruolo OWNER TO siig_p;
...
CREATE TABLE siig_mtd_d_elaborazione (
    ...
    descrizione_elaborazione_it character varying(50),
    descrizione_elaborazione_en character varying(50),
    descrizione_elaborazione_fr character varying(50),
    descrizione_elaborazione_de character varying(50)
);
...
--
-- Name: siig_t_export; Type: TABLE; Schema: siig_p; Owner: siig_p; Tablespace: 
--
...
CREATE TABLE siig_t_export (
    ...
    flg_stato character varying(1),
    xml_richiesta xml,
    CONSTRAINT dom_1_ri CHECK (((flg_stato)::text = ANY (ARRAY[('R'::character varying)::text, ('I'::character varying)::text])))
);


ALTER TABLE siig_p.siig_t_export OWNER TO siig_p;

--
-- Name: siig_t_file; Type: TABLE; Schema: siig_p; Owner: siig_p; Tablespace: 
--
...
ALTER TABLE siig_p.siig_t_file OWNER TO siig_p;
...
--
-- Name: siig_t_save; Type: TABLE; Schema: siig_p; Owner: siig_p; Tablespace: 
--
...
CREATE TABLE siig_t_save (
    ...
    nome_elaborazione character varying(100),
    flg_rigenerabile character varying(1),
    CONSTRAINT dom_1_sn CHECK (((flg_rigenerabile)::text = ANY (ARRAY[('S'::character varying)::text, ('N'::character varying)::text])))
);


ALTER TABLE siig_p.siig_t_save OWNER TO siig_p;

--
-- Name: siig_t_save_seq; Type: SEQUENCE; Schema: siig_p; Owner: siig_p
--

CREATE SEQUENCE siig_t_save_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE siig_p.siig_t_save_seq OWNER TO siig_p;
...
CREATE TABLE siig_t_scenario (
    ...
    tipologia_it character varying(100),
    tipologia_en character varying(100),
    tipologia_de character varying(100),
    tipologia_fr character varying(100)
);
...
CREATE TABLE siig_t_sostanza (
    ...
    nome_sostanza_it character varying(100),
    nome_sostanza_en character varying(100),
    nome_sostanza_de character varying(100),
    nome_sostanza_fr character varying(100)
);
...
--
-- Name: siig_t_utente; Type: TABLE; Schema: siig_p; Owner: siig_p; Tablespace: 
--
...
ALTER TABLE siig_p.siig_t_utente OWNER TO siig_p;
...
--
-- Name: v_geo_bersagli_ambientali; Type: VIEW; Schema: siig_p; Owner: siig_p
--

CREATE VIEW v_geo_bersagli_ambientali AS
    SELECT siig_t_bersaglio_non_umano.fk_bers_non_umano_pl AS id, siig_geo_bers_non_umano_pl.geometria, siig_t_bersaglio_non_umano.id_bersaglio FROM (siig_geo_bers_non_umano_pl JOIN siig_t_bersaglio_non_umano ON ((siig_geo_bers_non_umano_pl.idgeo_bers_non_umano_pl = siig_t_bersaglio_non_umano.fk_bers_non_umano_pl)));


ALTER TABLE siig_p.v_geo_bersagli_ambientali OWNER TO siig_p;

--
-- Name: v_geo_bersagli_umani; Type: VIEW; Schema: siig_p; Owner: siig_p
--

CREATE VIEW v_geo_bersagli_umani AS
    SELECT siig_t_bersaglio_umano.fk_bersaglio_umano_pl AS id, siig_geo_bersaglio_umano_pl.geometria, CASE WHEN (siig_t_bersaglio_umano.id_bersaglio = (1)::numeric) THEN siig_t_bersaglio_umano.residenti WHEN (siig_t_bersaglio_umano.id_bersaglio = (2)::numeric) THEN siig_t_bersaglio_umano.pres_max ELSE siig_t_bersaglio_umano.addetti END AS umani, siig_t_bersaglio_umano.id_bersaglio FROM (siig_geo_bersaglio_umano_pl JOIN siig_t_bersaglio_umano ON ((siig_geo_bersaglio_umano_pl.idgeo_bersaglio_umano_pl = siig_t_bersaglio_umano.fk_bersaglio_umano_pl)));


ALTER TABLE siig_p.v_geo_bersagli_umani OWNER TO siig_p;
...
--
-- Name: v_geo_grafo_ln; Type: VIEW; Schema: siig_p; Owner: siig_p
--

CREATE VIEW v_geo_grafo_ln AS
    SELECT siig_geo_ln_arco_1.id_geo_arco, siig_d_partner.partner_it, z_cat(CASE WHEN ((siig_r_tipovei_geoarco1.flg_densita_veicolare)::text = 'S'::text) THEN 'STIMATA'::text WHEN ((siig_r_tipovei_geoarco1.flg_densita_veicolare)::text = 'C'::text) THEN 'CALCOLATA'::text WHEN ((siig_r_tipovei_geoarco1.flg_densita_veicolare)::text = 'M'::text) THEN 'MODELLIZZATA'::text ELSE NULL::text END) AS tipo_densita_veicolare_leggeri_pesanti_it, z_cat(siig_r_tipovei_geoarco1.densita_veicolare) AS densita_veicolare, z_cat(CASE WHEN ((siig_r_tipovei_geoarco1.velocita_media)::text = 'S'::text) THEN 'STIMATA'::text WHEN ((siig_r_tipovei_geoarco1.velocita_media)::text = 'C'::text) THEN 'CALCOLATA'::text WHEN ((siig_r_tipovei_geoarco1.velocita_media)::text = 'M'::text) THEN 'MODELLIZZATA'::text ELSE NULL::text END) AS tipo_velocita_media_leggeri_pesanti_it, z_cat(siig_r_tipovei_geoarco1.velocita_media) AS velocita_media, CASE WHEN ((siig_geo_ln_arco_1.flg_nr_corsie)::text = 'S'::text) THEN 'STIMATO'::text WHEN ((siig_geo_ln_arco_1.flg_nr_corsie)::text = 'C'::text) THEN 'CALCOLATO'::text WHEN ((siig_geo_ln_arco_1.flg_nr_corsie)::text = 'M'::text) THEN 'MODELLIZZATO'::text ELSE NULL::text END AS fl_nr_corsie, siig_geo_ln_arco_1.nr_corsie, CASE WHEN ((siig_geo_ln_arco_1.flg_nr_incidenti)::text = 'S'::text) THEN 'STIMATO'::text WHEN ((siig_geo_ln_arco_1.flg_nr_incidenti)::text = 'C'::text) THEN 'CALCOLATO'::text WHEN ((siig_geo_ln_arco_1.flg_nr_incidenti)::text = 'M'::text) THEN 'MODELLIZZATO'::text ELSE NULL::text END AS flg_nr_incidenti, siig_geo_ln_arco_1.nr_incidenti, siig_geo_ln_arco_1.nr_incidenti_elab, siig_geo_ln_arco_1.lunghezza, z_cat(siig_d_dissesto.descrizione_it) AS elenco_dissesti, siig_geo_ln_arco_1.geometria FROM (((siig_d_partner JOIN siig_geo_ln_arco_1 ON (((siig_d_partner.id_partner)::text = (siig_geo_ln_arco_1.fk_partner)::text))) JOIN (siig_d_dissesto JOIN siig_r_arco_1_dissesto ON (((siig_d_dissesto.id_dissesto)::text = (siig_r_arco_1_dissesto.id_dissesto)::text))) ON ((siig_geo_ln_arco_1.id_geo_arco = siig_r_arco_1_dissesto.id_geo_arco))) JOIN siig_r_tipovei_geoarco1 ON ((siig_geo_ln_arco_1.id_geo_arco = siig_r_tipovei_geoarco1.id_geo_arco))) GROUP BY siig_geo_ln_arco_1.id_geo_arco, siig_geo_ln_arco_1.geometria, siig_geo_ln_arco_1.lunghezza, siig_d_partner.partner_it, siig_geo_ln_arco_1.nr_corsie, siig_geo_ln_arco_1.flg_nr_corsie, siig_geo_ln_arco_1.flg_nr_incidenti, siig_geo_ln_arco_1.nr_incidenti, siig_geo_ln_arco_1.nr_incidenti_elab ORDER BY siig_geo_ln_arco_1.id_geo_arco;


ALTER TABLE siig_p.v_geo_grafo_ln OWNER TO siig_p;
...
--
-- Name: pk_siig_d_dettaglio; Type: CONSTRAINT; Schema: siig_p; Owner: siig_p; Tablespace: 
--

ALTER TABLE ONLY siig_d_dettaglio
    ADD CONSTRAINT pk_siig_d_dettaglio PRIMARY KEY (id_dettaglio);
...
--
-- Name: pk_siig_d_ente; Type: CONSTRAINT; Schema: siig_p; Owner: siig_p; Tablespace: 
--

ALTER TABLE ONLY siig_d_ente
...
--
-- Name: pk_siig_d_ruolo; Type: CONSTRAINT; Schema: siig_p; Owner: siig_p; Tablespace: 
--

ALTER TABLE ONLY siig_d_ruolo
...
--
-- Name: pk_siig_t_export; Type: CONSTRAINT; Schema: siig_p; Owner: siig_p; Tablespace: 
--

ALTER TABLE ONLY siig_t_export
    ADD CONSTRAINT pk_siig_t_export PRIMARY KEY (id_export);


--
-- Name: pk_siig_t_file; Type: CONSTRAINT; Schema: siig_p; Owner: siig_p; Tablespace: 
--

ALTER TABLE ONLY siig_t_file
...
--
-- Name: pk_siig_t_save; Type: CONSTRAINT; Schema: siig_p; Owner: siig_p; Tablespace: 
--

ALTER TABLE ONLY siig_t_save
...
--
-- Name: pk_siig_t_utente; Type: CONSTRAINT; Schema: siig_p; Owner: siig_p; Tablespace: 
--

ALTER TABLE ONLY siig_t_utente
...
--
-- Name: idx_geo_arco_pl_3_partner; Type: INDEX; Schema: siig_p; Owner: siig_p; Tablespace: 
--

CREATE INDEX idx_geo_arco_pl_3_partner ON siig_geo_pl_arco_3 USING btree (fk_partner);
...
--
-- Name: siig_geo_pl_arco_3_gidx; Type: INDEX; Schema: siig_p; Owner: siig_p; Tablespace: 
--

CREATE INDEX siig_geo_pl_arco_3_gidx ON siig_geo_pl_arco_3 USING gist (geometria);
...
--
-- Name: fk_siig_d_dettaglio_01; Type: FK CONSTRAINT; Schema: siig_p; Owner: siig_p
--

ALTER TABLE ONLY siig_t_export
    ADD CONSTRAINT fk_siig_d_dettaglio_01 FOREIGN KEY (fk_dettaglio) REFERENCES siig_d_dettaglio(id_dettaglio);
...
--
-- Name: fk_siig_d_ente_01; Type: FK CONSTRAINT; Schema: siig_p; Owner: siig_p
--

ALTER TABLE ONLY siig_t_utente
    ADD CONSTRAINT fk_siig_d_ente_01 FOREIGN KEY (fk_ente) REFERENCES siig_d_ente(id_ente);
...
--
-- Name: fk_siig_d_ruolo_01; Type: FK CONSTRAINT; Schema: siig_p; Owner: siig_p
--

ALTER TABLE ONLY siig_t_utente
    ADD CONSTRAINT fk_siig_d_ruolo_01 FOREIGN KEY (fk_ruolo) REFERENCES siig_d_ruolo(id_ruolo);
...
--
-- Name: fk_siig_t_save_01; Type: FK CONSTRAINT; Schema: siig_p; Owner: siig_p
--

ALTER TABLE ONLY siig_t_file
    ADD CONSTRAINT fk_siig_t_save_01 FOREIGN KEY (id_save) REFERENCES siig_t_save(id_save);
...
--
-- Name: fk_siig_t_utente_02; Type: FK CONSTRAINT; Schema: siig_p; Owner: siig_p
--

ALTER TABLE ONLY siig_t_export
    ADD CONSTRAINT fk_siig_t_utente_02 FOREIGN KEY (fk_utente) REFERENCES siig_t_utente(id_utente);


--
-- Name: fk_siig_t_utente_03; Type: FK CONSTRAINT; Schema: siig_p; Owner: siig_p
--

ALTER TABLE ONLY siig_t_save
    ADD CONSTRAINT fk_siig_t_utente_03 FOREIGN KEY (fk_utente) REFERENCES siig_t_utente(id_utente);
