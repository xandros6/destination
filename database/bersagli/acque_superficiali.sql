...
insert into siig_t_bersaglio_non_umano(id_tematico,id_bersaglio,id_partner,fk_bers_non_umano_pl,denominazione,fk_classe_clc,toponimo_completo,superficie)
select "ID_TEMA",15,1,1924000+fid,"DENOM","FK_CLC","TOPONIMO","SUPERFICIE"
from "RP_V_BNU_ASUP_C_02";
